...
<b>Описание:</b> Пишите тесты до того, как вы напишете код. Если писать тесты до кода, это поможет думать больше о дизайне и стать более сфокусированным на задаче.
